  ...
  <body>
    ...
    <div class="navbar navbar-default navbar-static-top" role="navigation">
      ...
      <?php if ($thumbsEnable==1) { print "<li><a href=\"thumbs.php\">thumbs <span id=\"thumbsBadge\" class=\"badge\"></span></a></li>\n"; } ?>
	    ...
	    <a href="vids.php?older=<?php echo $oldestid . "&search=" . urlencode($partialurl); ?>"><button type="button" class="btn btn-default navbar-btn">
                   <span class="glyphicon glyphicon-arrow-left"></span>
                 </button></a>
            <a href="vids.php?newer=<?php echo $newestid . "&search=" . urlencode($partialurl); ?>"><button type="button" class="btn btn-default navbar-btn <?php if(!isset($_GET['newer']) && !isset($_GET['older'])){echo " disabled";} ?>">
